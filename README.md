...
| | |
|---|---|
| **1 722 kamper** | Kamper registrert totalt i arkivet |
| **1 887 kildedokumenterte resultatoppføringer** | Resultatobservasjoner bevart direkte fra historiske kilder; selve oppføringene teller ikke som kamper. **1 487 mangler fortsatt kobling til en kanonisk kamp.** |
...
| **455 historiske kilder** | Bøker, medlemsblad, årsmeldinger, nyhetssaker og andre dokumenter en enkelt opplysning kan peke på, med sidetall der det finnes |
...
| `pnpm ingest:nb-newspaper-batch -- --from ÅR --to ÅR [--window-days 2]` | Datoankret canonical→NB-discovery med OCR-fri, gjenopptakbar kandidatreport. Skriver aldri canonical data |
| `pnpm data:newspaper-enrichment-status` | Regenererer maskinlesbar kø og 1979-pilotmetrikk for canonical kamper uten samtidig Smp-dekning |
