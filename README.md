...
| | |
|---|---|
| **1 603 kamper** | Kamper registrert totalt i arkivet |
| **1777 kildedokumenterte resultatoppføringer** | Resultatobservasjoner bevart direkte fra historiske kilder; selve oppføringene teller ikke som kamper. **1 499 mangler fortsatt kobling til en kanonisk kamp.** |
| **98 år med kanoniske kamper** | 1915–2026, år med minst én registrert kamp. Enkeltkamper tilbake til 1915, cupen til 1917, regionale kretskamper til 1920 og nasjonal serie til 1951 |
| **107 år med historisk kampinformasjon** | De kanoniske årene over, pluss år som foreløpig bare har kildedokumenterte resultater. Sesongoversikten viser disse |
| **201 klubber · 97 stadion** | Med tidsavhengige navn, så 1975-kampen viser 1975-navnet |
...
| **28 historiske observasjoner** | Kildeførte enkeltfakta og hendelser som ikke hører til én bestemt kamp — verv, protester, pokaler, baneåpninger — vist på personen, sesongen, kampen eller banen de gjelder |
...
retter seg etter dem. For Sunnmørsposten går skillet ved 1936: årgangene til og med
1935 er merket fritt tilgjengelige under CC BY-NC-ND, og der lagres hele teksten med
kreditering. Fra 1936 er utgavene opphavsrettsbeskyttet og krever innlogging hos NB —
da lagres fakta, kildehenvisning og en lenke rett til siden, sammen med NBs egen
beskjed om hvordan leseren får tilgang.
...
Arkivet dekker 1 567 kamper fra 1915 til i dag. FotMob gir kampdetaljer og hendelser for
