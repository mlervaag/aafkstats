...
| `pnpm ingest:nb-newspaper-batch -- --dateless --season ÅR` | For kildeførte resultater uten dato: månedsvis kandidatliste, og bekreftet dato der resultatboksen navngir kampen |
