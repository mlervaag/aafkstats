        ...
        <div className="prose-stack">
          ...
          <section>
            ...
            <p>
              ...
              (utvalgte sesonger og tabeller), Sunnmøre Fotballkrets (historiske
              årsrapporter), manuelt konsulterte NFF-årbøker i Nasjonalbiblioteket og
              FotMob (nyere sesonger med hendelser og kampfakta, og
              tabellen for sesongen som pågår). FotMob er den eneste som gir
