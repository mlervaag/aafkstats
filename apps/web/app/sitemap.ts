...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  const staticPages = ["", "/sesonger", "/motstandere", "/klubben", "/personer", "/organisasjon", "/hjemmebaner", "/kilder", "/mangler", "/mangler/saker", "/mangler/oversikt", "/data", "/utviklere", "/om", "/bidra"];
