  ...
  return (
    <>
      ...
      <p className="small muted rights-intro" id="rettigheter-forklaring">
        Tabellen svarer på fire spørsmål. Om noe kan hentes, og om det kan publiseres videre,
        er to forskjellige spørsmål. Hva motparten har svart, er noe annet enn hva vi har
        bestemt. At en enkelt opplysning er et faktum uten opphavsrett, sier heller ingenting
        om vilkårene for samlingen den kom fra.
      </p>
