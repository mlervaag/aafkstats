...
const linkedEvidence = reviews.flatMap((entry) => entry.evidenceIssues)
...
const manifest = {
  version: 1, id, title: "Datoankret Sunnmørsposten-berikelse 1915–1962", profile: "generic_publication", mode: "initial", status: "normalized",
  ...
  previousWork: { pullRequests: [217, 219, 220, 221], notes: ["PR #217–#221 etablerte og skalerte produksjonsløypa til 1963–1979."] },
  baseRevision: "7616845c3ccd48e0e135b3cbb351c4bd150ebb66", createdAt: "2026-08-23",
