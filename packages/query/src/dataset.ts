...
export const views: ViewDoc[] = [
  ...
  },
  {
    ...
    columns: [
      ...
      { name: "competition_id", type: "text", description: "Konkurranse-ID når minst én kilde oppgir den og ingen motsier." },
      { name: "competition", type: "text", description: "Konkurransens visningsnavn. NULL når competition_id ikke finnes i konkurranseregisteret." },
      ...
      { name: "note", type: "text", description: "Kildenotatene satt sammen til én lesbar tekst. Bruk notes når du skal skille dem." },
      { name: "notes", type: "JSON", description: "Ett element per kildenotat. Notatene kommer fra ulike kilder og skal ikke tilskrives én av dem." },
      { name: "claim_summary", type: "JSON", description: "Hvor enige kildene i gruppen er om score, dato, motstanderidentitet og konkurranse. Beskriver intern enighet, ikke om påstanden er sann." },
  ...
  },
  {
    ...
    columns: [
      ...
      { name: "competition_id", type: "text", description: "Konkurransens stabile ID. Bruk denne til å koble mot seasons og result_groups; navnet endrer seg over tid, ID-en gjør det ikke." },
  ...
  },
  {
    ...
    caveats: [
      ...
      "coverage her gjelder én konkurranse. 'complete' på serieraden betyr at serien er hel, ikke at året er det: cupen kan mangle en kamp. Spør season_coverage når spørsmålet gjelder hele sesongen.",
  ...
  },
  {
    ...
    summary: "Én rad per sesongår med ett svar for hele året: er serien, cupen og et eventuelt europacupeventyr ferdig kanonisert? Bruk denne når spørsmålet er om et år er komplett; seasons.coverage svarer bare for én konkurranse om gangen.",
    caveats: [
      "Én rad per år, mot seasons som har én rad per år OG konkurranse. Et år er 'complete' bare når hver seriesesong er complete i seasons, cupen er spilt ferdig og europacupen er spilt ferdig.",
      "En cupsesong regnes som ferdig når den siste spilte kampen er et tap, en finale, eller en uavgjort avgjort på straffer. Slutter rekka på en seier som ikke er en finale, mangler arkivet minst én kamp. Om de første rundene mangler, kan ingen kilde i arkivet svare på: hvilken runde AaFK gikk inn i varierte med år og divisjon.",
      "Treningskamper teller ikke. Ingen kilde sier hvor mange treningskamper laget spilte et gitt år, så et krav om dem ville gjort hvert år ufullstendig for alltid.",
      "'unknown' betyr at arkivet ikke har noen seriesesong det året, ikke at året var tomt. Da kan vi ikke svare på om serien mangler.",
      "has_standings skiller det sterkeste belegget fra det nest sterkeste. Et år kan være 'complete' uten sluttabell når sesongfila oppgir omfanget med en note om hvor tallet kommer fra.",
    ],
    columns: [
      { name: "season", type: "integer", description: "Sesongår." },
      { name: "status", type: "text", description: "Året sett under ett: 'complete' (serie, cup og europacup ferdig kanonisert), 'partial' (noe mangler, se blocker), 'in_progress' (det står kamper igjen på terminlista), 'unknown' (arkivet har ingen seriesesong dette året)." },
      { name: "blocker", type: "text", description: "Hva som står igjen, i den rekkefølgen det bør rettes: 'none', 'season_in_progress', 'no_league_season', 'league_incomplete', 'cup_unfinished', 'european_unfinished'." },
      { name: "league_competitions", type: "integer", description: "Antall serierader året har i seasons. Som regel 1; 1967 har to." },
      { name: "league_complete", type: "integer", description: "Hvor mange av dem som er 'complete' i seasons." },
      { name: "cup_matches", type: "integer", description: "Spilte cupkamper året har i arkivet." },
      { name: "cup_closed", type: "integer (0/1)", description: "Om cuprekka slutter der den skal. NULL når året ikke har cupkamper i arkivet." },
      { name: "european_matches", type: "integer", description: "Spilte europacupkamper året har i arkivet." },
      { name: "european_closed", type: "integer (0/1)", description: "Om europacuprekka slutter der den skal. NULL når året ikke har europacupkamper." },
      { name: "has_standings", type: "integer (0/1)", description: "Om arkivet har sluttabellen for året." },
      { name: "scheduled", type: "integer", description: "Kamper som står igjen på terminlista, i alle konkurranser." },
    ],
  },
  {
    name: "opponents",
